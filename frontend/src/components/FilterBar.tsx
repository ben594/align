import {Menu, MenuButton, MenuList, MenuItemOption, Flex, IconButton, MenuOptionGroup, Input } from '@chakra-ui/react'
...
export default function FilterBar({ onSortChange, sortCriteria, tagSet, onFilterChange, onTagRemoved, mode, onToggleMode, searchText, onSearchChange }: FilterBarProps) {
    return (
        <Flex gap={4} paddingLeft={10} paddingRight={10}>
            ...
            </Menu>
            {
                mode === "tags" ? (
                    ...
                    <IconButton onClick={onToggleMode} icon={<FaTags/>} aria-label='Tags'/>
                    </>
                ) : 
                (
                    <>
